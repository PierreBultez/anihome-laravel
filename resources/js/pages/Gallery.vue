...
<template>
    <Head>
        <title>
            Album Photos : Nos Gardes d'Animaux à Courthézon – Anihome
        </title>
        <meta
            name="description"
        ...
        <meta
            property="og:title"
            content="Album Photos : Nos Gardes d'Animaux à Courthézon – Anihome"
        />
        <meta
            property="og:description"
            content="Découvrez notre grande famille d'animaux choyés à Courthézon et ses environs."
        />
        <meta
            property="og:image"
            content="https://anihome.fr/images/1000000707-scaled.webp"
        />
    ...
    <div class="bg-background">
        ...
        <div class="bg-muted/30 py-12 text-center">
            <h1 class="text-4xl font-bold text-primary">La grande famille</h1>
        </div>

        <div class="container mx-auto px-4 py-16">
            <div class="mb-16 text-center">
                <h2 class="mb-8 text-3xl font-bold text-primary">
                    Ils ont croisé notre route, une journée ou une vie…
                </h2>

                <div
                    class="mb-12 flex flex-col items-center justify-center gap-8 md:flex-row"
                >
                    <img
                        src="/images/comete_661_503.webp"
                        alt="Comete"
            ...
            >
                ...
                >
                    ...
                    >
                        <p class="px-2 text-center font-medium text-white">
                            {{ photo.title }}
                        </p>
                    </div>
                </div>
